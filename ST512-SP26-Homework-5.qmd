...
V($\hat{L}$) = MSE $\sum\frac{c_i^2}{n}$ = 56.38 * 4/5 = 45.10 

SE($\hat{L}$) = 6.72 

t = $\frac{\hat{L}}{SE(\hat{L})}$ = -5.7/6.72 = -0.848 

p-value = 0.201 > 0.05; FTR null

There is not a significant difference between the number of bites in the arm or neck in cold and and humid climates. 

## Problem 5 

N=299, df(error)= 295, MSE= $\frac{42088}{295}$= 142.67 
...
p.value= 1-pf(0.238,1,295) = 0.626
